...
async def gift_premium_msg(user_id, language):
    if language == "English":
        ...
        buttons = InlineKeyboardMarkup([
            [InlineKeyboardButton("For a day - $1.08", callback_data=f"frx_{user_id}_1_day")],
            [InlineKeyboardButton("For three days - $2.15", callback_data=f"frx_{user_id}_3_days")],
            [InlineKeyboardButton("For a week - $8.61", callback_data=f"frx_{user_id}_wek")],
            [InlineKeyboardButton("For a month - $12.98", callback_data=f"frx_{user_id}_mnt")]
        ])
    elif language == "Russian":
        ...
        buttons = InlineKeyboardMarkup([
            [InlineKeyboardButton("На день - 81₽", callback_data=f"frx_{user_id}_1_day")],
            [InlineKeyboardButton("На три дня - 162₽", callback_data=f"frx_{user_id}_3_days")],
            [InlineKeyboardButton("На неделю - 648₽", callback_data=f"frx_{user_id}_wek")],
            [InlineKeyboardButton("На месяц - 974₽", callback_data=f"frx_{user_id}_mnt")]
        ])
    elif language == "Azerbejani":
        ...
        buttons = InlineKeyboardMarkup([
            [InlineKeyboardButton("Bir gün üçün - 1,08 $", callback_data=f"frx_{user_id}_1_day")],
            [InlineKeyboardButton("Üç gün üçün - 2,15 $", callback_data=f"frx_{user_id}_3_days")],
            [InlineKeyboardButton("Bir həftə üçün - 8,61 $", callback_data=f"frx_{user_id}_wek")],
            [InlineKeyboardButton("Bir ay üçün - 12,98 $", callback_data=f"frx_{user_id}_mnt")]
        ])
    else:
        caption = "Invalid language specified."
        buttons = InlineKeyboardMarkup([])
